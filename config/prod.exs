...
# BisignalWeb.Endpoint.init/2 when load_from_system_env is
...
config :bisignal, BisignalWeb.Endpoint,
  ...
  url: [host: "powerful-plateau-56504.herokuapp.com/", port: 80],
...
# start per endpoint:
#
#     config :bisignal, BisignalWeb.Endpoint, server: true
#
